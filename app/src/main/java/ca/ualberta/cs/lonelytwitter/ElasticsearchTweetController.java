...
public class ElasticsearchTweetController {
    ...
    public static class AddTweetsTask extends AsyncTask<NormalTweet, Void, Void> {
        ...
        @Override
        protected Void doInBackground(NormalTweet... tweets) { //"..." for arbitary number of arguments
            verifySettings();
    ...
    public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<NormalTweet>> {
        @Override
        protected ArrayList<NormalTweet> doInBackground(String... search_parameters) { //a list of search parameters
            verifySettings();
            ...
            try {
               // TODO get the results of the query
                ...
                if (result.isSucceeded()){
                    ...
                    Log.i("Error","The search query to find any tweets that matched");
                }
            }
            catch (Exception e) {
